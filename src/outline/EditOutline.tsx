...
export const EditOutline: React.FC<IconProps> = ({
  size = 24,
  color,
  style,
  ...props
...
<path d="M19.8496 9.83C19.7796 9.83 19.7096 9.82 19.6496 9.8C17.0196 9.06 14.9296 6.97 14.1896 4.34C14.0796 3.94 14.3096 3.53 14.7096 3.41C15.1096 3.3 15.5196 3.53 15.6296 3.93C16.2296 6.06 17.9196 7.75 20.0496 8.35C20.4496 8.46 20.6796 8.88 20.5696 9.28C20.4796 9.62 20.1796 9.83 19.8496 9.83Z" fill="currentColor"/>
    </svg>
  );
};
