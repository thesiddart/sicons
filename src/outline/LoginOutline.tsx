...
export const LoginOutline: React.FC<IconProps> = ({
  size = 24,
  color,
  style,
  ...props
...
<path d="M12.6498 16.1C12.4598 16.1 12.2698 16.03 12.1198 15.88C11.8298 15.59 11.8298 15.11 12.1198 14.82L14.9398 12L12.1198 9.18003C11.8298 8.89003 11.8298 8.41003 12.1198 8.12003C12.4098 7.83003 12.8898 7.83003 13.1798 8.12003L16.5298 11.47C16.8198 11.76 16.8198 12.24 16.5298 12.53L13.1798 15.88C13.0298 16.03 12.8398 16.1 12.6498 16.1Z" fill="currentColor"/>
    </svg>
  );
};
