...
export const GlobalOutline: React.FC<IconProps> = ({
  size = 24,
  color,
  style,
  ...props
...
<path d="M15.0004 21.75C14.9204 21.75 14.8404 21.74 14.7604 21.71C14.3704 21.58 14.1504 21.15 14.2904 20.76C16.1704 15.11 16.1704 8.89 14.2904 3.23C14.1604 2.84 14.3704 2.41 14.7604 2.28C15.1604 2.15 15.5804 2.36 15.7104 2.75C17.7004 8.71 17.7004 15.27 15.7104 21.22C15.6104 21.55 15.3104 21.75 15.0004 21.75Z" fill="currentColor"/>
...
<path d="M20.9998 9.75C20.9198 9.75 20.8398 9.74 20.7598 9.71C15.1098 7.83 8.87978 7.83 3.22978 9.71C2.82978 9.84 2.40978 9.63 2.27978 9.24C2.15978 8.84 2.36978 8.42 2.75978 8.29C8.71978 6.3 15.2798 6.3 21.2298 8.29C21.6198 8.42 21.8398 8.85 21.6998 9.24C21.6098 9.55 21.3098 9.75 20.9998 9.75Z" fill="currentColor"/>
    </svg>
  );
};
