...
export const CardReceiveOutline: React.FC<IconProps> = ({
  size = 24,
  color,
  style,
  ...props
...
<path d="M19.9999 10.25C19.8099 10.25 19.6199 10.18 19.4699 10.03L17.4699 8.03C17.1799 7.74 17.1799 7.26 17.4699 6.97C17.7599 6.68 18.2399 6.68 18.5299 6.97L20.5299 8.97C20.8199 9.26 20.8199 9.74 20.5299 10.03C20.3799 10.18 20.1899 10.25 19.9999 10.25Z" fill="currentColor"/>
    </svg>
  );
};
