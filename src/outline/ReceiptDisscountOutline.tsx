...
export const ReceiptDisscountOutline: React.FC<IconProps> = ({
  size = 24,
  color,
  style,
  ...props
...
<path d="M8.62982 14.55C8.43982 14.55 8.24982 14.48 8.09982 14.33C7.80982 14.04 7.80982 13.56 8.09982 13.27L14.8298 6.54C15.1198 6.25 15.5998 6.25 15.8898 6.54C16.1798 6.83 16.1798 7.31 15.8898 7.6L9.15982 14.33C9.01982 14.48 8.82982 14.55 8.62982 14.55Z" fill="currentColor"/>
    </svg>
  );
};
