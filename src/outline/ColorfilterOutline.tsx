...
export const ColorfilterOutline: React.FC<IconProps> = ({
  size = 24,
  color,
  style,
  ...props
...
<path d="M16 22.75C14.33 22.75 12.73 22.13 11.5 21.02C11.34 20.88 11.25 20.67 11.25 20.46C11.25 20.25 11.34 20.04 11.5 19.9C12.61 18.92 13.25 17.5 13.25 16C13.25 15.33 13.13 14.68 12.88 14.07C12.8 13.87 12.81 13.65 12.91 13.46C13.01 13.27 13.18 13.13 13.38 13.07C14.97 12.64 16.27 11.47 16.88 9.94001C17.02 9.58001 17.41 9.40001 17.77 9.49001C20.7 10.29 22.74 12.96 22.74 16C22.75 19.72 19.72 22.75 16 22.75ZM13.12 20.39C13.97 20.95 14.96 21.25 16 21.25C18.89 21.25 21.25 18.89 21.25 16C21.25 13.85 19.93 11.93 17.98 11.13C17.24 12.54 16 13.66 14.52 14.26C14.67 14.82 14.75 15.41 14.75 16C14.75 17.62 14.17 19.18 13.12 20.39Z" fill="currentColor"/>
    </svg>
  );
};
