...
export const ArchiveTickOutline: React.FC<IconProps> = ({
  size = 24,
  color,
  style,
  ...props
...
<path d="M11.0903 13.25C10.9003 13.25 10.7103 13.18 10.5603 13.03L9.06027 11.53C8.77027 11.24 8.77027 10.76 9.06027 10.47C9.35027 10.18 9.83027 10.18 10.1203 10.47L11.0903 11.44L14.5603 7.97C14.8503 7.68 15.3303 7.68 15.6203 7.97C15.9103 8.26 15.9103 8.74 15.6203 9.03L11.6203 13.03C11.4703 13.18 11.2803 13.25 11.0903 13.25Z" fill="currentColor"/>
    </svg>
  );
};
