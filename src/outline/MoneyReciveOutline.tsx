...
export const MoneyReciveOutline: React.FC<IconProps> = ({
  size = 24,
  color,
  style,
  ...props
...
<path d="M21 7.75H17C16.59 7.75 16.25 7.41 16.25 7V3C16.25 2.59 16.59 2.25 17 2.25C17.41 2.25 17.75 2.59 17.75 3V6.25H21C21.41 6.25 21.75 6.59 21.75 7C21.75 7.41 21.41 7.75 21 7.75Z" fill="currentColor"/>
<path d="M16.9999 7.75C16.8099 7.75 16.6199 7.68 16.4699 7.53C16.1799 7.24 16.1799 6.76 16.4699 6.47L21.4699 1.47C21.7599 1.18 22.2399 1.18 22.5299 1.47C22.8199 1.76 22.8199 2.24 22.5299 2.53L17.5299 7.53C17.3799 7.68 17.1899 7.75 16.9999 7.75Z" fill="currentColor"/>
    </svg>
  );
};
