...
export const Code1Outline: React.FC<IconProps> = ({
  size = 24,
  color,
  style,
  ...props
...
<path d="M2.23047 8.76C1.82047 8.76 1.48047 8.42 1.48047 8.01C1.48047 7.6 1.81047 7.26 2.23047 7.26L21.4505 7.25C21.8605 7.25 22.2005 7.59 22.2005 8C22.2005 8.41 21.8705 8.75 21.4505 8.75L2.23047 8.76Z" fill="currentColor"/>
    </svg>
  );
};
