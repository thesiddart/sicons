...
export const RefreshBulk: React.FC<IconProps> = ({
  size = 24,
  color,
  style,
  ...props
...
<path opacity="0.4" d="M12 16C14.2091 16 16 14.2091 16 12C16 9.79086 14.2091 8 12 8C9.79086 8 8 9.79086 8 12C8 14.2091 9.79086 16 12 16Z" fill="currentColor"/>
    </svg>
  );
};
