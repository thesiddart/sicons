...
export const DocumentFavoriteBulk: React.FC<IconProps> = ({
  size = 24,
  color,
  style,
  ...props
...
<path d="M11.1602 12.7299C10.5702 12.5399 9.9402 12.6499 9.5002 12.9999C9.0402 12.6499 8.4302 12.5399 7.8502 12.7299C6.5802 13.1399 6.1802 14.5899 6.5302 15.6999C7.0702 17.3999 8.8602 18.2699 9.5102 18.2699C10.1402 18.2699 11.9602 17.3699 12.4902 15.6999C12.8302 14.5899 12.4302 13.1399 11.1602 12.7299Z" fill="currentColor"/>
    </svg>
  );
};
