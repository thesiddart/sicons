...
export const TextUnderlineBulk: React.FC<IconProps> = ({
  size = 24,
  color,
  style,
  ...props
...
<path d="M16.8299 18.96H7.16992C6.75992 18.96 6.41992 18.62 6.41992 18.21C6.41992 17.8 6.75992 17.46 7.16992 17.46H16.8399C17.2499 17.46 17.5899 17.8 17.5899 18.21C17.5899 18.62 17.2499 18.96 16.8299 18.96Z" fill="currentColor"/>
