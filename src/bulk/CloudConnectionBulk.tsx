...
export const CloudConnectionBulk: React.FC<IconProps> = ({
  size = 24,
  color,
  style,
  ...props
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path opacity="0.4" d="M19.2 14.7802C18.34 15.5702 17.2 16.0102 16.03 16.0002H6.36997C2.29997 15.7102 2.28997 9.80017 6.36997 9.51017H6.40998C3.61998 1.75017 15.41 -1.33985 16.76 6.80015C20.53 7.28015 22.06 12.2902 19.2 14.7802Z" fill="currentColor"/>
