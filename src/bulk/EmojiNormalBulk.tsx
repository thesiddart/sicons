...
export const EmojiNormalBulk: React.FC<IconProps> = ({
  size = 24,
  color,
  style,
  ...props
...
<path d="M15.5999 12.6201H8.39988C7.69988 12.6201 7.12988 13.1901 7.12988 13.9001C7.12988 16.5901 9.31988 18.7801 12.0099 18.7801C14.6999 18.7801 16.8899 16.5901 16.8899 13.9001C16.8799 13.2001 16.2999 12.6201 15.5999 12.6201Z" fill="currentColor"/>
    </svg>
  );
};
