...
export const SliderHorizontalBulk: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  ...props
}) => {
...
<path opacity="0.4" d="M7.6001 21.25H16.4001C18.0601 21.25 19.4001 19.91 19.4001 18.25V5.75C19.4001 4.09 18.0601 2.75 16.4001 2.75H7.6001C5.9401 2.75 4.6001 4.09 4.6001 5.75V18.25C4.6001 19.91 5.9401 21.25 7.6001 21.25Z" fill="currentColor"/>
    </svg>
  );
};
