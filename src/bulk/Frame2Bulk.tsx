...
export const Frame2Bulk: React.FC<IconProps> = ({
  size = 24,
  color,
  style,
  ...props
...
<path d="M11.9999 9.14014C10.4299 9.14014 9.1499 10.4201 9.1499 12.0001C9.1499 13.5701 10.4299 14.8501 11.9999 14.8501C13.5699 14.8501 14.8599 13.5701 14.8599 12.0001C14.8599 10.4301 13.5699 9.14014 11.9999 9.14014Z" fill="currentColor"/>
    </svg>
  );
};
