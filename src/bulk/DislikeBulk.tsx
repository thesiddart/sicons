...
<path d="M18.7899 17.6099H19.8199C21.3699 17.6099 21.9999 17.0099 21.9999 15.5299V5.4799C21.9999 3.9999 21.3699 3.3999 19.8199 3.3999H18.7899C17.2399 3.3999 16.6099 3.9999 16.6099 5.4799V15.5399C16.6099 17.0099 17.2399 17.6099 18.7899 17.6099Z" fill="currentColor"/>
    </svg>
  );
};
