...
export const StatusUpBulk: React.FC<IconProps> = ({
  size = 24,
  color,
  style,
  ...props
...
<path d="M17.1201 18.9002C16.7101 18.9002 16.3701 18.5602 16.3701 18.1502V11.9302C16.3701 11.5202 16.7101 11.1802 17.1201 11.1802C17.5301 11.1802 17.8701 11.5202 17.8701 11.9302V18.1502C17.8701 18.5702 17.5401 18.9002 17.1201 18.9002Z" fill="currentColor"/>
