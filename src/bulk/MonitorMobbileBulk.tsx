...
<path d="M19.64 9.5H14.35C12.62 9.5 11.99 10.13 11.99 11.88V19.61C11.99 21.37 12.61 21.99 14.35 21.99H19.64C21.37 21.99 22 21.36 22 19.61V11.88C22 10.12 21.38 9.5 19.64 9.5ZM17 20.32C16.39 20.32 15.9 19.83 15.9 19.22C15.9 18.61 16.39 18.12 17 18.12C17.61 18.12 18.1 18.61 18.1 19.22C18.1 19.83 17.61 20.32 17 20.32Z" fill="currentColor"/>
<path opacity="0.4" d="M18.0999 19.2201C18.0999 19.8301 17.6099 20.3201 16.9999 20.3201C16.3899 20.3201 15.8999 19.8301 15.8999 19.2201C15.8999 18.6101 16.3899 18.1201 16.9999 18.1201C17.6099 18.1201 18.0999 18.6201 18.0999 19.2201Z" fill="currentColor"/>
    </svg>
  );
};
