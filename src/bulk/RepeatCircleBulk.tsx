...
export const RepeatCircleBulk: React.FC<IconProps> = ({
  size = 24,
  color,
  style,
  ...props
...
<path d="M17.19 15.3701C17.15 15.2801 17.1 15.2001 17.03 15.1301L15.34 13.4401C15.05 13.1501 14.57 13.1501 14.28 13.4401C13.99 13.7301 13.99 14.2101 14.28 14.5001L14.69 14.91H9.10001C8.63001 14.91 8.25 14.5301 8.25 14.0601V12.29C8.25 11.88 7.91 11.54 7.5 11.54C7.09 11.54 6.75 11.88 6.75 12.29V14.0601C6.75 15.3601 7.81001 16.41 9.10001 16.41H14.69L14.28 16.8201C13.99 17.1101 13.99 17.5901 14.28 17.8801C14.43 18.0301 14.62 18.1 14.81 18.1C15 18.1 15.19 18.0301 15.34 17.8801L17.03 16.1901C17.1 16.1201 17.15 16.0401 17.19 15.9501C17.27 15.7601 17.27 15.5501 17.19 15.3701Z" fill="currentColor"/>
    </svg>
  );
};
