...
export const NotificationFavoriteBulk: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  ...props
}) => {
...
<path d="M10.9 12.3599C10.33 12.1799 9.71998 12.2799 9.28998 12.6199C8.84998 12.2799 8.24998 12.1799 7.68998 12.3599C6.45998 12.7599 6.06998 14.1599 6.41998 15.2399C6.94998 16.8799 8.67998 17.7299 9.29998 17.7299C9.90998 17.7299 11.67 16.8599 12.18 15.2399C12.53 14.1599 12.13 12.7599 10.9 12.3599Z" fill="currentColor"/>
    </svg>
  );
};
