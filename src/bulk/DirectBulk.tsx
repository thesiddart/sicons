...
export const DirectBulk: React.FC<IconProps> = ({
  size = 24,
  color,
  style,
  ...props
...
<path d="M14.3302 10.5899H9.67021C9.28021 10.5899 8.97021 10.2799 8.97021 9.88994C8.97021 9.49994 9.28021 9.18994 9.67021 9.18994H14.3202C14.7102 9.18994 15.0202 9.49994 15.0202 9.88994C15.0202 10.2799 14.7102 10.5899 14.3302 10.5899Z" fill="currentColor"/>
    </svg>
  );
};
