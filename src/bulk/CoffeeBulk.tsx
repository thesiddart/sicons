...
export const CoffeeBulk: React.FC<IconProps> = ({
  size = 24,
  color,
  style,
  ...props
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path opacity="0.6" d="M17.79 10.4698V11.9998H2V10.4698C2 8.14977 3.89 6.25977 6.21 6.25977H13.58C15.9 6.25977 17.79 8.14977 17.79 10.4698Z" fill="currentColor"/>
