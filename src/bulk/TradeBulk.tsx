...
export const TradeBulk: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  ...props
}) => {
...
<path d="M18.4102 21.9998H21.0002C21.5502 21.9998 22.0002 21.5498 22.0002 20.9998V18.4098C22.0002 17.5198 20.9202 17.0698 20.2902 17.6998L17.7002 20.2898C17.0802 20.9198 17.5202 21.9998 18.4102 21.9998Z" fill="currentColor"/>
    </svg>
  );
};
