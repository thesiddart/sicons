...
export const Tag2Bulk: React.FC<IconProps> = ({
  size = 24,
  color,
  style,
  ...props
...
<path d="M13.0004 17.7499C12.8104 17.7499 12.6204 17.6799 12.4704 17.5299C12.1804 17.2399 12.1804 16.7599 12.4704 16.4699L16.4704 12.4699C16.7604 12.1799 17.2404 12.1799 17.5304 12.4699C17.8204 12.7599 17.8204 13.2399 17.5304 13.5299L13.5304 17.5299C13.3804 17.6799 13.1904 17.7499 13.0004 17.7499Z" fill="currentColor"/>
    </svg>
  );
};
