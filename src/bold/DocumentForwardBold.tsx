...
export const DocumentForwardBold: React.FC<IconProps> = ({
  size = 24,
  color,
  style,
  ...props
...
<path d="M17.4301 8.80999C18.3801 8.81999 19.7001 8.81999 20.8301 8.81999C21.4001 8.81999 21.7001 8.14999 21.3001 7.74999C19.8601 6.29999 17.2801 3.68999 15.8001 2.20999C15.3901 1.79999 14.6801 2.07999 14.6801 2.64999V6.13999C14.6801 7.59999 15.9201 8.80999 17.4301 8.80999Z" fill="currentColor"/>
    </svg>
  );
};
