...
export const SidebarRightBold: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  ...props
}) => {
...
<path d="M16.78 2.02979V21.9798C18.01 21.8998 19.05 21.5498 19.87 20.9498C20.29 20.6598 20.66 20.2898 20.95 19.8698C21.64 18.9198 22 17.6798 22 16.1898V7.80978C22 4.36978 20.06 2.23979 16.78 2.02979Z" fill="currentColor"/>
    </svg>
  );
};
