...
export const GalleryBold: React.FC<IconProps> = ({
  size = 24,
  color,
  style,
  ...props
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M2.58005 19.0098L2.56005 19.0298C2.29005 18.4398 2.12005 17.7698 2.05005 17.0298C2.12005 17.7598 2.31005 18.4198 2.58005 19.0098Z" fill="currentColor"/>
