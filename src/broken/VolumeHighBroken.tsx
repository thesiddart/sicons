...
export const VolumeHighBroken: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  ...props
}) => {
...
<path d="M19.8301 18.5C21.2801 16.57 22.0001 14.29 22.0001 12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M19.8301 5.5C20.4201 6.28 20.8801 7.12 21.2301 8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  );
};
