...
export const BrushBroken: React.FC<IconProps> = ({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12.98 8.32001H4V4C4 2.9 4.9 2 6 2H18C19.1 2 20 2.9 20 4V8.32001H16.93" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
