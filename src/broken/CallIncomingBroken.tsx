...
export const CallIncomingBroken: React.FC<IconProps> = ({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M16.1992 7.8H20.9992M16.1992 4.95V3V4.95ZM16.1992 7.8V7.01V7.8Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
