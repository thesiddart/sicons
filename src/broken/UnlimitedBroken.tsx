...
export const UnlimitedBroken: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  ...props
}) => {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M20.0003 15.77C19.2703 16.26 18.4003 16.5499 17.4603 16.5499C15.9603 16.5499 14.6503 15.8099 13.8203 14.6799" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
