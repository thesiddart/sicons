...
export const BluetoothRectangleBroken: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  ...props
}) => {
...
<path d="M4 7C4 4 6 2 9 2H15C18 2 20 4 20 7V17C20 20 18 22 15 22H9C6 22 4 20 4 17V11.03" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  );
};
