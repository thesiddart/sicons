...
export const ProgrammingArrowBroken: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  ...props
}) => {
...
<path d="M5.25 2C3.46 2 2 3.46 2 5.25C2 7.04 3.46 8.5 5.25 8.5C7.04 8.5 8.5 7.04 8.5 5.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
